...
export class AppComponent implements AfterViewInit {
  ...
  constructor(public servicioPuente: ComunicacionEntreComponentesService,
    public messageService: MessageService,
    private el: ElementRef, private renderer: Renderer2, private location: Location, @Inject(PLATFORM_ID) private platformId: Object, public servicio1Db: ServicioApi1DbService)
  {
